...
🤖 AI-Powered "Visual Proof" Verification Unlike standard reminder apps that can be blindly dismissed, MedAware introduces Adherence Assurance through Computer Vision.
...
Intelligent Status Labeling: Verified: AI confirms both the user's face and the medicine in a single frame.
...
📊 Comprehensive Adherence Reporting Bridge the communication gap between elderly parents and their children with data-driven insights.
...
📅 Smart Medication Management A complete workflow from registration to restocking.
...
👤 Personalized Health Profiles Secure onboarding that captures essential vitals (Age, Weight, Height, Gender) to ensure all reminders are contextualized to the specific user's health needs.

🛠️ Tech Stack Frontend React Native, Expo Backend Flask Database My_SQL AI Model

🚀 Getting Started Prerequisites Node.js (v18+) npm Expo Go app

Installation Clone the repo:

Bash git clone https://github.com/yourusername/MedAware.git cd MedAware

Install dependencies: Bash npm install

Run the app: Bash npx expo start

📱 APK Download To test the application on an Android device:
...
🏗️ Architecture The app follows a modular architecture to ensure scalability and easy integration of health data.

👥 The Team Member 1 - Raghav Deo
